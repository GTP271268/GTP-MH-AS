...
import com.gtp.myhistory.zxingutils.camera.CreateQRBitmp;
import com.gtp.myhistory.zxingutils.dialog.ImageOptDialog;
import com.gtp.myhistory.zxingutils.utils.BitmapUtil;
import com.gtp.myhistory.zxingutils.utils.ZxingImageUtil;
...
public class ZxingActivity extends AppCompatActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.generate_qr_code://生成二维码
                    ...
                    Bitmap portrait = BitmapFactory.decodeResource(getResources(), R.mipmap.logo);
                    //两个方法，一个不传大小，使用默认
    ...
    private void longPress() {
        ...
        imageOptDialog.setCallback(new ImageOptDialog.ImageOptCallback() {
            ...
            public void onSaveImageClick() {
                ...
                Bitmap temBitmap = view.getDrawingCache();
                ZxingImageUtil.savePicToLocal(temBitmap, ZxingActivity.this);
    ...
    private void showToast(String str) {
        Toast.makeText(ZxingActivity.this, str, Toast.LENGTH_LONG).show();
    }
}
