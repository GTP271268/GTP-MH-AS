...
//                    Toast.makeText(context, "图片不存在，请检查后重试", Toast.LENGTH_SHORT).show();
//
//                    return;
//                }
...
//                        Toast.makeText(context, "第" + (i + 1) + "张图片不存在，请检查后重试", Toast.LENGTH_SHORT).show();
//                        return;
//                    }
            ...
            Toast.makeText(context, "第" + "分享失败，未知错误", Toast.LENGTH_SHORT).show();
        }
    }
